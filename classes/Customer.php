...
if(preg_match("/^[a-zA-Z_]{3,}$/", $_POST["name"]) === 0)
{
$msg = "<span class='error'>User name must be bigger than 3 chars and must contain only  letters</span>";
return $msg;
}
...
{
$msg = "<span class='error'>Password must be at least 5 characters and must contain at least one lower case letter, one upper case letter and one digit</span>";
return $msg;
}
